...
<table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
 ...
 <a href="/customer/hapus/{{$cust->idcust}}" onclick="return confirm('Ingin menghapus data?')" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
...
<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
 ...
 <input type="number" name="addidcust" id="addidcust" class="form-control" maxlegth="5" id="exampleFormControlInput1" >
 </div>
 <div class="form-group">
 <label for="exampleFormControlInput1">Nama Customer</label>
 <input type="text" name="addnmcust" id="addnmcust" class="form-control" id="exampleFormControlInput1" >
 </div>
 <div class="form-group">
 <label for="exampleFormControlInput1">No Handphone</label>
 <input type="number" name="addnohp" id="nohp" class="form-control" id="exampleFormControlInput1" >
 </div>
 <div class="form-group">
 <label for="exampleFormControlInput1">Email</label>
 <input type="text" name="addemail" id="addemail" class="form-control" id="exampleFormControlInput1" >
 </div>
 <div class="form-group">
